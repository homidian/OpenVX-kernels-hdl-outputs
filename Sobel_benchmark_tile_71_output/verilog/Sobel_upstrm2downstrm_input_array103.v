...
module Sobel_upstrm2downstrm_input_array103 (
        ...
        dst_V_pixel143_write,
        dst_V_pixel144_din,
        dst_V_pixel144_full_n,
        dst_V_pixel144_write
);
...
output  [7:0] dst_V_pixel143_din;
input   dst_V_pixel143_full_n;
output   dst_V_pixel143_write;
output  [7:0] dst_V_pixel144_din;
input   dst_V_pixel144_full_n;
output   dst_V_pixel144_write;
...
reg    dst_V_pixel143_blk_n;
reg    dst_V_pixel144_blk_n;
wire   [8:0] i_2_fu_1878_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_777 & ~(exitcond4_fu_1872_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond4_fu_1872_p2 == 1'b0) & ~ap_sig_777)) begin
        i_reg_1861 <= i_2_fu_1878_p2;
    end else if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_786)) begin
        i_reg_1861 <= ap_const_lv9_0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_777 & ~(exitcond4_fu_1872_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_777 & ~(exitcond4_fu_1872_p2 == 1'b0))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond4_fu_1872_p2 == 1'b0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if ((~ap_sig_777 & ~(exitcond4_fu_1872_p2 == 1'b0))) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else if (((exitcond4_fu_1872_p2 == 1'b0) & ~ap_sig_777)) begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end else begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end
...
assign exitcond4_fu_1872_p2 = ((i_reg_1861 == ap_const_lv9_1E2) ? 1'b1 : 1'b0);

assign i_2_fu_1878_p2 = (i_reg_1861 + ap_const_lv9_1);
