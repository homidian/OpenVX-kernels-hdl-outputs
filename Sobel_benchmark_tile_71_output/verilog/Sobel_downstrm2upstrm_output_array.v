...
module Sobel_downstrm2upstrm_output_array (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_sig_757 = (((exitcond4_fu_1822_p2 == 1'b0) & (src_V_pixel_10_status == 1'b0)) | ((exitcond4_fu_1822_p2 == 1'b0) & (dst_V_pixel_11_status == 1'b0)));
end
...
assign i_7_fu_1828_p2 = (i_reg_1811 + ap_const_lv9_1);
...
endmodule //Sobel_downstrm2upstrm_output_array
