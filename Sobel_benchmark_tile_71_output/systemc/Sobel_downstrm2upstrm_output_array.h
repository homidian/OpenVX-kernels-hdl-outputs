...
#ifndef _Sobel_downstrm2upstrm_output_array_HH_
#define _Sobel_downstrm2upstrm_output_array_HH_
...
struct Sobel_downstrm2upstrm_output_array : public sc_module {
    ...
    // Module declarations
    Sobel_downstrm2upstrm_output_array(sc_module_name name);
    SC_HAS_PROCESS(Sobel_downstrm2upstrm_output_array);

    ~Sobel_downstrm2upstrm_output_array();
    ...
    sc_signal< sc_lv<9> > i_7_fu_1828_p2;
