...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_477 & ~(exitcond3_fu_1123_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond3_fu_1123_p2 == 1'b0) & ~ap_sig_477)) begin
        i_reg_1112 <= i_9_fu_1129_p2;
    end else if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_486)) begin
        i_reg_1112 <= ap_const_lv9_0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_477 & ~(exitcond3_fu_1123_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_477 & ~(exitcond3_fu_1123_p2 == 1'b0))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond3_fu_1123_p2 == 1'b0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if ((~ap_sig_477 & ~(exitcond3_fu_1123_p2 == 1'b0))) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else if (((exitcond3_fu_1123_p2 == 1'b0) & ~ap_sig_477)) begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end else begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end
...
always @ (*) begin
    ap_sig_377 = (1'b1 == ap_CS_fsm[ap_const_lv32_1]);
end

always @ (*) begin
    ap_sig_477 = (((exitcond3_fu_1123_p2 == 1'b0) & (src_V_pixel_1_luma0_status == 1'b0)) | ((exitcond3_fu_1123_p2 == 1'b0) & (dst_V_pixel_11_status == 1'b0)));
end

always @ (*) begin
    ap_sig_486 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign dst_V_pixel_43_din = src_V_pixel_41_luma_dout;
...
assign exitcond3_fu_1123_p2 = ((i_reg_1112 == ap_const_lv9_1E0) ? 1'b1 : 1'b0);

assign i_9_fu_1129_p2 = (i_reg_1112 + ap_const_lv9_1);
