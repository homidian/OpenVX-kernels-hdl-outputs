...
module Sobel_upstrm2downstrm_input_array103 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_487 & ~(exitcond4_fu_1147_p2 == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond4_fu_1147_p2 == 1'b0) & ~ap_sig_487)) begin
        i_reg_1136 <= i_2_fu_1153_p2;
    end else if (((1'b1 == ap_sig_cseq_ST_st1_fsm_0) & ~ap_sig_496)) begin
        i_reg_1136 <= ap_const_lv9_0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_487 & ~(exitcond4_fu_1147_p2 == 1'b0)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & ~ap_sig_487 & ~(exitcond4_fu_1147_p2 == 1'b0))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond4_fu_1147_p2 == 1'b0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_st2_fsm_1 : begin
            if ((~ap_sig_487 & ~(exitcond4_fu_1147_p2 == 1'b0))) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else if (((exitcond4_fu_1147_p2 == 1'b0) & ~ap_sig_487)) begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end else begin
                ap_NS_fsm = ap_ST_st2_fsm_1;
            end
...
assign exitcond4_fu_1147_p2 = ((i_reg_1136 == ap_const_lv9_1E2) ? 1'b1 : 1'b0);

assign i_2_fu_1153_p2 = (i_reg_1136 + ap_const_lv9_1);
...
endmodule //Sobel_upstrm2downstrm_input_array103
