...
architecture behav of Sobel_rgb2yuv_bt709 is 
    ...
    signal grp_fu_123_p3 : STD_LOGIC_VECTOR (22 downto 0);
    signal grp_fu_114_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_fu_114_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_114_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_fu_114_p2 : STD_LOGIC_VECTOR (22 downto 0);
    signal grp_fu_123_p0 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_fu_123_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal grp_fu_123_p2 : STD_LOGIC_VECTOR (20 downto 0);
    signal grp_fu_114_p00 : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_fu_114_p20 : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_fu_123_p00 : STD_LOGIC_VECTOR (22 downto 0);
    signal grp_fu_123_p20 : STD_LOGIC_VECTOR (22 downto 0);
...
begin
    Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253 : component Sobel_mac_muladd_16ns_9ns_23ns_24_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254 : component Sobel_mac_muladd_16ns_7ns_21ns_23_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    ap_return <= grp_fu_114_p3(23 downto 16);
    ...
    grp_fu_114_p00 <= std_logic_vector(resize(unsigned(f_g_fu_55_p3),24));
    grp_fu_114_p1 <= ap_const_lv24_B7(9 - 1 downto 0);
    grp_fu_114_p2 <= grp_fu_114_p20(23 - 1 downto 0);
    grp_fu_114_p20 <= std_logic_vector(resize(unsigned(grp_fu_123_p3),24));
    grp_fu_123_p0 <= grp_fu_123_p00(16 - 1 downto 0);
    grp_fu_123_p00 <= std_logic_vector(resize(unsigned(f_r_fu_48_p3),23));
    grp_fu_123_p1 <= ap_const_lv23_36(7 - 1 downto 0);
    grp_fu_123_p2 <= grp_fu_123_p20(21 - 1 downto 0);
    grp_fu_123_p20 <= std_logic_vector(resize(unsigned(tmp_5_fu_92_p2),23));
