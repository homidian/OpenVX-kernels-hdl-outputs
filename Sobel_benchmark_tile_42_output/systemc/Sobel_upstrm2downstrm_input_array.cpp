...
void Sobel_upstrm2downstrm_input_array::thread_ap_sig_385() {
    ap_sig_385 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(1, 1));
}

void Sobel_upstrm2downstrm_input_array::thread_ap_sig_487() {
    ap_sig_487 = ((esl_seteq<1,1,1>(exitcond4_fu_1147_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(src_V_pixel_10_status.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(exitcond4_fu_1147_p2.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(dst_V_pixel_11_status.read(), ap_const_logic_0)));
}

void Sobel_upstrm2downstrm_input_array::thread_ap_sig_496() {
...
void Sobel_upstrm2downstrm_input_array::thread_exitcond4_fu_1147_p2() {
    exitcond4_fu_1147_p2 = (!i_reg_1136.read().is_01() || !ap_const_lv9_1E2.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_1136.read() == ap_const_lv9_1E2);
}

void Sobel_upstrm2downstrm_input_array::thread_i_2_fu_1153_p2() {
