...
struct Sobel_downstrm2upstrm_output_array10_1 : public sc_module {
    ...
    sc_out< sc_lv<8> > dst_V_pixel42_din;
    sc_in< sc_logic > dst_V_pixel42_full_n;
    sc_out< sc_logic > dst_V_pixel42_write;
    sc_out< sc_lv<8> > dst_V_pixel43_din;
    sc_in< sc_logic > dst_V_pixel43_full_n;
    sc_out< sc_logic > dst_V_pixel43_write;
    ...
    sc_signal< sc_lv<1> > exitcond4_fu_1097_p2;
    ...
    sc_signal< sc_logic > dst_V_pixel42_blk_n;
    sc_signal< sc_logic > dst_V_pixel43_blk_n;
    ...
    void thread_dst_V_pixel42_blk_n();
    void thread_dst_V_pixel42_din();
    void thread_dst_V_pixel42_write();
    void thread_dst_V_pixel43_blk_n();
    void thread_dst_V_pixel43_din();
    void thread_dst_V_pixel43_write();
    ...
    void thread_exitcond4_fu_1097_p2();
    void thread_i_6_fu_1103_p2();
