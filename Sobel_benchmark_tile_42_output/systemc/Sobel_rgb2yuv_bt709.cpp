...
Sobel_rgb2yuv_bt709::Sobel_rgb2yuv_bt709(sc_module_name name) : sc_module(name), mVcdFile(0) {
    Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253 = new Sobel_mac_muladd_16ns_9ns_23ns_24_1<1,1,16,9,23,24>("Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253");
    Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253->din0(grp_fu_114_p0);
    Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253->din1(grp_fu_114_p1);
    Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253->din2(grp_fu_114_p2);
    Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253->dout(grp_fu_114_p3);
    Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254 = new Sobel_mac_muladd_16ns_7ns_21ns_23_1<1,1,16,7,21,23>("Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254");
    Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254->din0(grp_fu_123_p0);
    Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254->din1(grp_fu_123_p1);
    Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254->din2(grp_fu_123_p2);
    Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254->dout(grp_fu_123_p3);
...
Sobel_rgb2yuv_bt709::~Sobel_rgb2yuv_bt709() {
    ...
    delete Sobel_mac_muladd_16ns_9ns_23ns_24_1_U253;
    delete Sobel_mac_muladd_16ns_7ns_21ns_23_1_U254;
}
...
void Sobel_rgb2yuv_bt709::thread_ap_return() {
    ap_return = grp_fu_114_p3.read().range(23, 16);
}
...
void Sobel_rgb2yuv_bt709::thread_grp_fu_114_p00() {
    grp_fu_114_p00 = esl_zext<24,16>(f_g_fu_55_p3.read());
}

void Sobel_rgb2yuv_bt709::thread_grp_fu_114_p1() {
    grp_fu_114_p1 =  (sc_lv<9>) (ap_const_lv24_B7);
}

void Sobel_rgb2yuv_bt709::thread_grp_fu_114_p2() {
    grp_fu_114_p2 =  (sc_lv<23>) (grp_fu_114_p20.read());
}

void Sobel_rgb2yuv_bt709::thread_grp_fu_114_p20() {
    grp_fu_114_p20 = esl_zext<24,23>(grp_fu_123_p3.read());
}
...
void Sobel_rgb2yuv_bt709::thread_grp_fu_123_p00() {
    grp_fu_123_p00 = esl_zext<23,16>(f_r_fu_48_p3.read());
}

void Sobel_rgb2yuv_bt709::thread_grp_fu_123_p1() {
    grp_fu_123_p1 =  (sc_lv<7>) (ap_const_lv23_36);
}

void Sobel_rgb2yuv_bt709::thread_grp_fu_123_p2() {
    grp_fu_123_p2 =  (sc_lv<21>) (grp_fu_123_p20.read());
}

void Sobel_rgb2yuv_bt709::thread_grp_fu_123_p20() {
    grp_fu_123_p20 = esl_zext<23,21>(tmp_5_fu_92_p2.read());
}
